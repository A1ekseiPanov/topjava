...
public class MealsUtil {
    ...
    public static List<MealTo> getFilteredByTime(Collection<Meal> meals, int caloriesPerDay, LocalTime startTime, LocalTime endTime) {
        return filterByPredicate(meals, caloriesPerDay, meal -> DateTimeUtil.timeIsBetweenTimeHalfOpen(meal.getTime(), startTime, endTime));
    }
    ...
    public static List<MealTo> getFilteredByDate(Collection<Meal> meals, int caloriesPerDay, LocalDate startDate, LocalDate endDate) {
        return filterByPredicate(meals, caloriesPerDay, meal -> DateTimeUtil.dateIsBetweenClosed(meal.getDate(), startDate, endDate));
    }
